...
/*
CUSD NFT ERC721 Staking Smart Contract.
...
import "https://github.com/Stanislav-petrov-stw/CSS-Contracts/CUSD-ERC20-Token-Contract-v3.sol";
...
contract NFTStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(ERC721Enumerable _nft, CUSDRewards _token) { 
    nft = _nft;
    token = _token;
  }
...
/*
@Net2Dev - Follow me on Youtube , Tiktok, Instagram. Do it he is great.
...
rewardmath = 10 ether .... (This gives 0.1 token per day per NFT staked to the staker)
